...
class VersionSelector extends React.Component {
  ...
  render() {
    return <Select value={this.props.selectedVersion} onChange={this.props.selectVersion}>
...
class EndTestButton extends React.Component {
  ...
  render() {
    return <div>
      <Button onClick={this.showModal} type={Button.TYPE.DESTRUCTIVE}>End test</Button>
  ...
  render() {
    return <Grid className="endTestSection">
      ...
      <GridItem columnStart={5} columnEnd={6} className="versionSelector">
        <VersionSelector selectedVersion={this.state.selectedVersion} selectVersion={this.selectVersion} />
      </GridItem>
